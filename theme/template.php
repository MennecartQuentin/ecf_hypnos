...
<meta name="description" content="Hypnos Hotel template project">
...
<?php
if (isset($_SESSION['ecfhypnos_cart'])){
  if (count($_SESSION['ecfhypnos_cart'])>0) {
    $cart =  count($_SESSION['ecfhypnos_cart'])  ;
  } 
...
<div class="super_container">
  <header class="header">
    <div class="header_content d-flex flex-column align-items-center justify-content-lg-end justify-content-center">
      ...
      <!-- Logo -->
      <div class="logo"><a href="#"><img class="logo_1" src="<?php echo WEB_ROOT;?>images/logo_1.png" alt=""><img class="logo_2" src="<?php echo WEB_ROOT;?>images/logo.png" alt=""><img class="logo_3" src="<?php echo WEB_ROOT;?>images/logo.png" alt=""></a></div>
...
<!--         <div class="search_button">
  ...
  <div class="logo_overlay">
    <div class="logo_overlay_content d-flex flex-column align-items-center justify-content-center">
      <div class="logo"><a href="#"><img src="<?php echo WEB_ROOT;?>images/logo_1.png" alt=""></a></div>
    </div>
  </div>
            ...
            <div class="row">
              ...
              <div class="col-lg-4 footer_col">
                <div class="footer_info d-flex flex-column align-items-lg-start align-items-center justify-content-start">
                  <div class="text-center">
                    <div>Mail:</div>
                    <div>hotel.hypnos@contact.com</div>
                  </div>
                </div>
              </div>
            </div>
